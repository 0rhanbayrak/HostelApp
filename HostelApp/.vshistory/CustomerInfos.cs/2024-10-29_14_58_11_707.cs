...
namespace HostelApp
{
    public partial class CustomerInfos : Form
    {
        ...
        {
            link.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO USERINFO (Name,Surname,ID_NO,Birth_date,Birth_place) VALUES (@pName,@pSurname,@pID_NO,@pBirth_date,@pBirth_place)", link);
        ...
        {
            link.Open();
            SqlCommand cmd = new SqlCommand("DELETE FROM USERINFO WHERE Id=@pId", link);
