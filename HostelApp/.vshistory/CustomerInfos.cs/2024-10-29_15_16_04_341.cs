...
namespace HostelApp
{
    public partial class CustomerInfos : Form
    {
        ...
        private void register_button_Click(object sender, EventArgs e)//Adding new values.
        {
            ...
            cmd.Parameters.AddWithValue("@pName", RtextBoxId.Text);
            cmd.Parameters.AddWithValue("@pName", RtextBoxId.Text);
            cmd.Parameters.AddWithValue("@pSurname", RtextBoxName.Text);
            cmd.Parameters.AddWithValue("@pID_NO", RtextBoxSurname.Text);
            cmd.Parameters.AddWithValue("@pBirth_date", RtextBoxGender.Text);
            cmd.Parameters.AddWithValue("@pBirth_place", RtextBoxPhoneNo.Text);
            cmd.Parameters.AddWithValue("@pName", RtextBoxId.Text);
            cmd.Parameters.AddWithValue("@pName", RtextBoxId.Text);
            cmd.Parameters.AddWithValue("@pName", RtextBoxId.Text);
            cmd.Parameters.AddWithValue("@pName", RtextBoxId.Text);
