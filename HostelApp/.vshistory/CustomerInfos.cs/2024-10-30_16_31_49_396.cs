...
namespace HostelApp
{
    public partial class CustomerInfos : Form
    {
        ...
        private void register_button_Click_1(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@pGender", RtextBoxGender.Text);
            ...
            cmd.Parameters.AddWithValue("@pCheckInDate", RtextBoxCheckInDate.Text);
            cmd.Parameters.AddWithValue("@pCheckOutDate", RtextBoxCheckOutDate.Text);
