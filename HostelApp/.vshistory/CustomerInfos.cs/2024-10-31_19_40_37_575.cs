...
namespace HostelApp
{
    public partial class CustomerInfos : Form
    {
        ...
        {
            link.Open();
            SqlCommand cmd = new SqlCommand("UPDATE CUSTOMERINFO SET (Name=@pName,Surname=@pSurname,Gender=@pGender,PhoneNo=@pPhoneNo,Mail=@pMail,IDNO=@pIDNO,RoomNo=@pRoomNo,CheckInDate=@pCheckInDate,CheckOutDate=@pCheckOutDate,Price=@pPrice)", link);
