...
namespace HostelApp
{
    public partial class CustomerRegister : Form
    {
        ...
        private void Btn101_Click(object sender, EventArgs e)
        {
            link.Open();
            bool IsOccupied;
            SqlCommand cmd = new SqlCommand("INSERT INTO BUTTONINFO (Id,ButtonName,IsOccupied) VALUES (@pId,@pButtonName,@pIsOccupied)",link);
            cmd.Parameters.AddWithValue("@pId",1);
            cmd.Parameters.AddWithValue("@pButtonName", Btn101.Name);
            cmd.Parameters.AddWithValue("@pIsOccupied", 1);
        }
