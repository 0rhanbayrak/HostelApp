...
namespace HostelApp
{
    public partial class CustomerRegister : Form
    {
        ...
        private void LoadButtonStates()
        {
            ...
            {
                connection.Open();
                string query = "SELECT ButtonName, IsOccupied FROM BUTTONINFO"; // ButtonName ve IsOccupied'ı al
        ...
        private void SaveButtonState(string buttonName, bool isOccupied)
        {
            ...
            {
                connection.Open();
                string query = "UPDATE BUTTONINFO SET IsOccupied = @IsOccupied WHERE ButtonName = @ButtonName"; // ButtonName'a göre güncelle
                SqlCommand command = new SqlCommand(query, connection);
