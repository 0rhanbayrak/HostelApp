        ...
        public partial class CustomerRegister : Form
        {
            ...
            //Btn103
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (isOccupied == 1)
                    {
                        Btn103.BackColor = Color.Red; // Buton rengi kırmızı yapılıyor
                    }
                }
            ...
            //Btn201
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (isOccupied == 1)
                    {
                        Btn201.BackColor = Color.Red; // Buton rengi kırmızı yapılıyor
                    }
                }
            ...
            //Btn202
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (isOccupied == 1)
                    {
                        Btn202.BackColor = Color.Red; // Buton rengi kırmızı yapılıyor
                    }
                }
            ...
            //Btn203
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (isOccupied == 1)
                    {
                        Btn203.BackColor = Color.Red; // Buton rengi kırmızı yapılıyor
                    }
                }
            ...
            //Btn301
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (isOccupied == 1)
                    {
                        Btn301.BackColor = Color.Red; // Buton rengi kırmızı yapılıyor
                    }
                }
            ...
            //Btn302
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (isOccupied == 1)
                    {
                        Btn302.BackColor = Color.Red; // Buton rengi kırmızı yapılıyor
                    }
                }
            ...
            //Btn303
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (isOccupied == 1)
                    {
                        Btn303.BackColor = Color.Red; // Buton rengi kırmızı yapılıyor
                    }
                }
