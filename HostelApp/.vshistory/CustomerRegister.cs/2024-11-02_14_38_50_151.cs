...
namespace HostelApp
{
        ...
        private void Btn101_Click(object sender, EventArgs e)
        {
            ...
            {
            if (Btn201.BackColor == Color.LawnGreen)
            {
                link.Open();
                int IsOccupied = 0;
                IsOccupied++;
            ...
            {
            link.Open();
            if (Btn202.BackColor == Color.LawnGreen)
            {
                int IsOccupied = 0;
                IsOccupied++;
                SqlCommand cmd = new SqlCommand("INSERT INTO BUTTONINFO (ButtonName,IsOccupied) VALUES (@pButtonName,@pIsOccupied)", link);
            ...
            {
            link.Open();
            if (Btn203.BackColor == Color.LawnGreen)
            {
                int IsOccupied = 0;
                IsOccupied++;
                SqlCommand cmd = new SqlCommand("INSERT INTO BUTTONINFO (ButtonName,IsOccupied) VALUES (@pButtonName,@pIsOccupied)", link);
            ...
            {
            if (Btn301.BackColor == Color.LawnGreen)
            {
                link.Open();
                int IsOccupied = 0;
                IsOccupied++;
        ...
        {
            link.Open();
            if (Btn302.BackColor == Color.LawnGreen)
            {
                int IsOccupied = 0;
                IsOccupied++;
                SqlCommand cmd = new SqlCommand("INSERT INTO BUTTONINFO (ButtonName,IsOccupied) VALUES (@pButtonName,@pIsOccupied)", link);
        ...
        {
            link.Open();
            if (Btn303.BackColor == Color.LawnGreen)
            {
                int IsOccupied = 0;
                IsOccupied++;
                SqlCommand cmd = new SqlCommand("INSERT INTO BUTTONINFO (ButtonName,IsOccupied) VALUES (@pButtonName,@pIsOccupied)", link);
